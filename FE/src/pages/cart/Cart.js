    ...
    return (
        <div className={'cart'}>
            ...
            {stage === 3 ? (
                ...
                <p>Thank you for buying our meteorites! we are sure you will like them. Your money will be used to buy the neccessary supplements the crew on the ISS needs. <br></br>
            ...
            <section className={'Items'}>
                ...
                <section className='payment'>
                    <Checkout amount={total} currency='usd' state={stage} setstate={setStage} func={setParentStage}/>
                </section>
            )}
            <section className='cartTotal'>
                ...
                <br />
                {stage === 1 ? (
                <button className='btn btn--primary' onClick={moveStage} disabled={cart.length===0 ? true : false}>Checkout</button>
                ) : (<></>)}
            </section>
            </>
            )}
