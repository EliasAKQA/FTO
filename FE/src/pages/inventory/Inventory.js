    ...
    return (
        <div className='main__container--lesswidth '>
            <section className={"inventory__header"}>
                ...
                <p>Resources like food and water are constantly being used by the crew on the ISS. That is why the staion needs to be restocked. Here you can see how much food and water is currently lrft on the ISS and for how long the crew can last with that amount.</p>
            ...
            <p>We are selling meteoriters found and signed by our astronauts at our shop! The money we make by selling these meteorites is then used to resupply the ISS with the neccessary resources they need.</p>
