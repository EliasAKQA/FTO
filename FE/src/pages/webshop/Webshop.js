...
const Webshop = () => {
    ...
    return (
        <div className='main__container--lesswidth'>
            ...
            <p className='WebshopText'>The meteorites in our shop where discoverd by none other than out astronauts!
                Each meteorite is signed by the astronaut who fond it.
                Buy a meteorite signed by your favorite astronaut and get it delivered to you all the eay from
                space!</p>
